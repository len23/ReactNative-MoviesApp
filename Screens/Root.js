...
export default Root = () => {
    return(
    <Tab.Navigator  screenOptions={{ headerShown: false, tabBarStyle:{backgroundColor:'#000', borderTopColor:'#000'}, tabBarActiveTintColor: '#f5c518', tabBarShowLabel: false  }} >
        <Tab.Screen name="Home" component={Home} options={{tabBarIcon:({color}) => (
             <Ionicons name="home" color={color} size={30}/>
        )}}/>
        <Tab.Screen name="BookMarkList" component={BookMarkList} options={{tabBarIcon:({color}) => (
